...
export const DRINK_SMOKE_OPTIONS: PickerOption[] = [
  ...
  { label: 'Occasionally drinks, doesn\'t smoke', value: 'Occasionally drinks, doesn\'t smoke' },
  { label: 'Regularly drinks, doesn\'t smoke', value: 'Regularly drinks, doesn\'t smoke' },
  { label: 'Doesn\'t drink, occasionally smokes', value: 'Doesn\'t drink, occasionally smokes' },
  { label: 'Doesn\'t drink, regularly smokes', value: 'Doesn\'t drink, regularly smokes' },
