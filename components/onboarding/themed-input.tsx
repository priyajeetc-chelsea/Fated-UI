...
export default function ThemedInput({
  ...
  const isMinimumMet = minimumCharacters
    ? value.trim().length >= minimumCharacters
    : true;
  const characterCountColor = minimumCharacters
    ? isMinimumMet
      ? "#4CAF50"
      : "#FF4444"
    : "#666";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        {showCharacterCount && maxLength && (
          <Text
            style={[styles.characterCounter, { color: characterCountColor }]}
          >
